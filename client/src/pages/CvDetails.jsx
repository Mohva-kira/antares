    ...
    <div className="space-y-4">
      {experiences?.map((exp, index) => (
        <div key={index} className="bg-gray-50 p-4 rounded-2xl shadow-md">
          ...
          <p className="text-gray-600">{`${exp.begin} jusqu'à ${exp.end}`}</p>
    ...
    <div className="space-y-4">
      {education.map((edu, index) => (
        <div key={index} className="bg-gray-50 p-4 rounded-2xl shadow-md">
          ...
          <p className="text-gray-600">{`${edu.begin} jusqu'à ${edu.end}`}</p>
          ...
          <div className="container mx-auto p-4">
            <div className="bg-white border border-gray-200 rounded-2xl shadow-lg p-6">
              ...
              <div className="flex items-center mb-6">
                ...
                />
                <div>
                  <h1 className="text-2xl capitalize font-bold mb-1">
                    {user?.user.username}
                  </h1>
                  <p className="text-gray-600 mb-2">{findCv.jobTitle}</p>
                  <p className="text-gray-600 mb-1">{user?.user.email}</p>
              ...
              {data ? (
                <div className="w-full">
                  {/* Sections dynamiques */}
                  <ExperienceSection
                    experiences={data?.data[0]?.attributes.experience}
                  />
                  <EducationSection
                    education={data?.data[0]?.attributes.education}
                  />
                  ...
                  <div className="mb-6">
                    ...
                    <ul className="list-disc ml-6 text-gray-700">
                      {data?.data[0]?.attributes.skills.map((skill, index) => (
                ...
                <div className="w-full">
                  <p className="text-3xl">Veuillez créer un cv</p>
                </div>
              )}
            </div>
          </div>
