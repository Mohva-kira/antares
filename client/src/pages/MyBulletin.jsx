...
import { usePostBulletinMutation } from "../redux/bulletin";
...
const MyBulletin = () => {
  ...
  const { activite, adresse, email, name, phone, site, nb_emplees } =
    ...
    const [postBulletin, { data: bulletinData, isLoading: bulletinIsLoading, error: bulletinError }] = usePostBulletinMutation();
