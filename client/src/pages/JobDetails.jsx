...
const ExperienceSection = ({ objectif }) => (
  <div className="mb-6">
    ...
    <div className="space-y-4">
      {objectif?.map((exp, index) => (
        <div key={index} className="bg-gray-50 p-4 rounded-2xl shadow-md">
          ...
          <p className="text-gray-600 flex w-full gap-4 p-2 mt-2"><h2>Type de contrat</h2> <h2 className='font-bold'>{exp.type}</h2> </p>
          <p className="text-gray-600 flex w-full gap-4 p-2 mt-2"><h2>Date de debut</h2> <h2 className='font-bold'>{exp.date}</h2></p>
          <ul className="list-disc ml-6  text-gray-700  p-2 mt-2">{exp.details}</ul>
        </div>
      ))}
    </div>
  </div>
...
const JobDetails = () => {
  ...
  const cvDataList = [
    {
      ...
      skills: [
        { name: "Prendre en charge des actions de communication média/hors média", level: 90 },
        { name: "Gérer et coordonner toutes les étapes de production des campagnes de communication confiées (Briefs débrief-BAT-Exe-Prod-Lancement-Suivi-Bilan)", level: 85 },
        { name: "Travailler avec l’agence de communication après la validation du brief com sur les créas/spots & archivage des versions finales)", level: 80 },
      ],
      recommendations: [
        {
      ...
      education: [
        {
          ...
          details: "Bac + 3 en science sociale, communication, en sciences sociales, développement international, gestion de projet, ou tout autre domaine pertinent. Connaissances Spécifiques :	–        Intérêt marqué pour la redevabilité, la gestion de projet et l’humanitaire.– Excellentes capacités de communication et d’écoute."     
        },
        {
          title: "Connaissances Spécifiques",
          institution: "Université de Bamako",
          dates: "Septembre 2014 - Juin 2016",
          details: "Capacité à travailler en équipe et à distance. Rigueur, autonomie, et proactivité. "
        ...
        },
        {
          ...
          institution: "Université de Bamako",
          dates: "Septembre 2014 - Juin 2016",
          details: "  Aisance dans la gestion de bases de données et la rédaction de rapports."     
        },
      ],
      additionalInfo:
  ...
  console.log('found cv', findCv)
  return (
    <Container>
      <Breadcumb title={`Job / ${findCv.name  }`} />
      <div className="flex flex-col lg:flex-row w-full">
        ...
        <div className='w-full bg-white rounded-2xl flex justify-center p-4'> 
             <button className='bg-orange-400 text-white p-2 font-bold rounded-xl text-xl'>Postuler</button>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl shadow-lg p-6">
            ...
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-2">{findCv.title}</p>
            ...
            {/* Sections dynamiques */}
            <ExperienceSection objectif={findCv.objectif} />
